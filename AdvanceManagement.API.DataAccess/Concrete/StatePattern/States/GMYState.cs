...
namespace AdvanceManagement.API.DataAccess.Concrete.StatePattern.States
{
    public class GMYState : State
    {
        ...
        public GMYState(StateMachine stateMachine, AdvanceRequestStatus advanceRequest, IDbTransaction dbTransaction, IAdvanceRequestStatusDataAccess dal) : base(stateMachine)
        {
